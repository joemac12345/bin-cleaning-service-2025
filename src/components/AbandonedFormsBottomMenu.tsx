...
import { TrendingDown, Users, AlertCircle, RefreshCw, Download, Trash2 } from 'lucide-react';
            ...
            <>
              ...
              {onClearAll && (
                <button
                  onClick={onClearAll}
                  disabled={isLoading}
                  className="flex-1 px-4 py-2 bg-red-600 dark:bg-red-700 text-white rounded-lg hover:bg-red-700 dark:hover:bg-red-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center space-x-2 text-sm"
                >
