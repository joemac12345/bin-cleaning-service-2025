...
export function FormContainer({ children, maxWidth = '2xl', variant = 'default', fullWidthOnMobile = false, className = '' }: FormContainerProps) {
  ...
  const responsiveClasses = fullWidthOnMobile 
    ? `w-full min-h-screen md:${maxWidthClasses[maxWidth]} md:h-auto mx-0 md:mx-auto rounded-none md:rounded-2xl flex flex-col px-4 py-6 sm:px-6 sm:py-8 md:px-8 md:py-8`
    : `${maxWidthClasses[maxWidth]} mx-auto px-4 py-6 sm:px-6 sm:py-8`;
